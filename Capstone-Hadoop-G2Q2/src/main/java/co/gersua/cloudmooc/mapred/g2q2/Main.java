...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job airportsByNumberJob = Job.getInstance(conf, "Airport and destination airports departures delay");
        ...
        /******************/
        Job topAirportsJob = Job.getInstance(conf, "top 10 destination airports on-time dapartures by airport");
