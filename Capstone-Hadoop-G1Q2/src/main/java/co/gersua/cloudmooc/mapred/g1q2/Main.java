...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job airportsByNumberJob = Job.getInstance(conf, "airlines by on-time arrival performance");

        airportsByNumberJob.setOutputKeyClass(Text.class);
        airportsByNumberJob.setOutputValueClass(DoubleWritable.class);

        airportsByNumberJob.setMapperClass(AirlinesByOnTimeArrivalPerformanceMapper.class);
        airportsByNumberJob.setReducerClass(AirlinesByOnTimeArrivalPerformanceReducer.class);
        ...
        /******************/
        Job topAirportsJob = Job.getInstance(conf, "top 10 airlines by on-time arrival performance");
        ...
        topAirportsJob.setMapperClass(Top10AirlinesMapper.class);
        topAirportsJob.setReducerClass(Top10AirlinesReducer.class);
