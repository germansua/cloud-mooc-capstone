...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        airportsByNumberJob.setMapperClass(SourceDestCarrierOnTimeArrivalMapper.class);
        airportsByNumberJob.setReducerClass(SourceDestCarrierOnTimeArrivalReducer.class);
